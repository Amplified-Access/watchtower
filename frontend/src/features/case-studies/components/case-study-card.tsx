...
// The image and the text block are the article's only two children, so a
// parent grid can line cards up by image row via `grid-rows-subgrid`.
const CaseStudyCard = ({
  caseStudy,
  className,
  imageClassName,
  ...
  return (
    <article className={cn("group flex flex-col", className)}>
      <div
        className={cn(
          "relative aspect-7/4 overflow-hidden bg-dark/5",
          imageClassName,
        )}
      >
        <Image
