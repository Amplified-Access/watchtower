...
const IncidentTypesContent = () => {
  ...
  return (
    <Container className="py-8 space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your organization's incident types. Enable existing types or
            create new ones.
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Your Organization's Incident Types</CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Available Incident Types</CardTitle>
          <CardDescription>
