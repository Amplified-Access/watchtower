...
// Seed incidents within a fixed one-year window ending on 15 March 2026.
const SEED_END_DATE = new Date("2026-03-15T23:59:59.999Z");
const SEED_START_DATE = new Date("2025-03-15T00:00:00.000Z");
  ...
  try {
    ...
    for (const incidentType of types) {
      ...
      for (let i = 0; i < 400; i++) {
        ...
        // Add small random variation to coordinates to spread incidents
